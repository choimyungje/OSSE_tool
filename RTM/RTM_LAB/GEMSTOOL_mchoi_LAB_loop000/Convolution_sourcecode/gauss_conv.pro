pro gauss_conv,solref_wl,solrefspec,ap_lambda,wave_range,convol_spec,n_sample, FWHM, con_rag,c_shift,c_squeeze
...
convol_spec = dblarr(n_sample)  ;convolved measured spectrum array^M
...
for i_lambda = 0d, n_sample-1 do begin
   ...
   for i_index = 0d, n_index-1 do begin
      ...
      gauss_ft=exp(-(d_lambda)^2.0/ hw1e ^2.0)
