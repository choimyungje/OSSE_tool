PRO make_xsec_lut_using_absco_v5_mchoi  ;, wn_range, wn_res
...
atmos_file = '../PTH_PROFILES/atmos_mchoi_t09.dat'
print, atmos_file
...
for ngas = 0, n_elements(gas)-2 do begin ;;--no CH4 data currently
