...
for ngas = 0, 2 do begin 

;	goto, goto_test
	hdf_pwd = '/home/mchoi/GEMSTOOL_mchoi_20181105_iron/GEMSTOOL_physicsdata/LUT_Xsections_data/ABSCO_table_hdf'
	files_name = ['h2o_hitran12.h5', $
				  'co2_devi2015_wco2scale-nist_sco2scale-unity.h5', $
				  'o2_v151005_cia_mlawer_v151005r1_narrow.h5'] ;     V500,  ---no available data for ch4
	; files_name = ['h2o_v4.2.0.hdf', $
	; 			  'co2_v4.2.0_with_ctm.hdf', $
	; 			  'o2_v4.2.0_drouin.hdf'] ;     V420,  ---no available data for ch4
