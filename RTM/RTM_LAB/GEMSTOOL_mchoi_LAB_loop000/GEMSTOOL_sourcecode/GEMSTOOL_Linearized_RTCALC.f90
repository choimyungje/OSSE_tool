...
subroutine GEMSTOOL_RTCALC_PLUS_Actual &
    (  do_Profile_Jacobians, do_AerOpdepProfile_Jacobians,                  & ! Main control
       ...
       GEMSTOOL_SLEAVE_Results, GEMSTOOL_BRDF_Results,GEMSTOOL_BRDF_Results_Lin, & ! Surface Supplement Results
...
!  BRDF input structure, added 10/25/16
   ...
   TYPE(VBRDF_LinSup_Outputs), INTENT(IN) :: GEMSTOOL_BRDF_Results_Lin !mchoi
...
!   VBRDF inputs are all pre-initialized; emissivities not requird
   ...
   ! write(*,*)'GEMSTOOL_Linearized_RTCALC: N_SURFACE_WFS ', VBRDF_LinSup_In%BS_N_SURFACE_WFS
   ! write(*,*)'GEMSTOOL_Linearized_RTCALC: N_SURFACE_WFS ', VLIDORT_LinFixIn%Cont%TS_N_SURFACE_WFS
   ! pause
   ...
   if ( .not.VLIDORT_FixIn%Bool%TS_DO_LAMBERTIAN_SURFACE ) THEN 
      ...
      !added by mchoi
      VLIDORT_LinSup%BRDF%TS_LS_EXACTDB_BRDFUNC = GEMSTOOL_BRDF_Results_Lin%BS_LS_DBOUNCE_BRDFUNC
      VLIDORT_LinSup%BRDF%TS_LS_BRDF_F_0        = GEMSTOOL_BRDF_Results_Lin%BS_LS_BRDF_F_0
      VLIDORT_LinSup%BRDF%TS_LS_BRDF_F          = GEMSTOOL_BRDF_Results_Lin%BS_LS_BRDF_F
      VLIDORT_LinSup%BRDF%TS_LS_USER_BRDF_F_0   = GEMSTOOL_BRDF_Results_Lin%BS_LS_USER_BRDF_F_0
      VLIDORT_LinSup%BRDF%TS_LS_USER_BRDF_F     = GEMSTOOL_BRDF_Results_Lin%BS_LS_USER_BRDF_F
      VLIDORT_LinSup%BRDF%TS_LS_EMISSIVITY      = GEMSTOOL_BRDF_Results_Lin%BS_LS_EMISSIVITY
      VLIDORT_LinSup%BRDF%TS_LS_USER_EMISSIVITY = GEMSTOOL_BRDF_Results_Lin%BS_LS_USER_EMISSIVITY
