...
subroutine GEMSTOOL_NSW_regular_iops &
     ( maxlayers, maxmoments_input, maxstokes_sq,                            & ! VLIDORT dimensions
       ...
       w, wavnum, omega_lim, do_gases, ngases, nstokes, nlayers, nwav,       & ! GEMSTOOL Inputs
...
!  VLIDORT Bulk properties. Use limiting value for OMEGA
      ...
      ENDIF
!         write(36,*)W,N,DELTAU_VERT_INPUT(N)
!         write(38,*)W,N,OMEGA_TOTAL_INPUT(N)
...
567 format(i5,f12.5,1p8e17.7)
   ...
   write(34,567)w,wavnum,sum(TABS(1:NLAYERS,1)),sum(TABS(1:NLAYERS,2)),sum(TABS(1:NLAYERS,3)),sum(TABS(1:NLAYERS,4))
