module FastV2p7_LRRS2p5a_Master_m
...
subroutine FastV2p7_LRRS2p5a_Master &
...
!  Modified Inputs (All)
   ...
   LRRS_ModIn%MBool%DO_BIN_REALIZATION    = .true.  ! Always true
...
!  Fixed integers and numbers
   ...
   LRRS_FixIn%UserVal%N_LOUTPUT          = 1
...
!  Finish
   ...
   return
end subroutine FastV2p7_LRRS2p5a_Master

!  End module

end module FastV2p7_LRRS2p5a_Master_m
