...
!  Flag for overall single scatter condition
...
!mick fix 10/19/2015 - added status initializations
!  set status
...
!  error handling
          ...
          IF ( FAIL ) THEN
            WRITE(C2,'(I2)')LAYER
            MESSAGE = 'L_Fourier master, call to HOMOG_SOLUTION, layer'//C2
            WRITE(C3, '(I3)' ) CPT
...
!    - Equally valid for profile or column linearization
          ...
          IF ( DO_ATMOS_WFS ) THEN
            ...
            IF ( FAIL ) THEN
              WRITE(C2,'(I2)')LAYER
              MESSAGE = 'L_Fourier master, call to LPC_HOMOG_SOLUTION, layer'//C2
              WRITE(C3, '(I3)' ) CPT
              POINT_TRACE = 'Linearized Homog. Calculation: point number: '//C3
              RETURN
            ENDIF
          ENDIF
...
!  (Error tracing)
          ...
          IF ( INFO .NE. 0 ) THEN
            FAIL = .TRUE.
            WRITE(C3, '(I3)' ) CPT
            POINT_TRACE = 'Raman Fourier Radiances/Jacobians, point number: '//C3
            RETURN
          ENDIF
...
!  (Error tracing)
          ...
          IF ( INFO .GT. 0 ) THEN
            ...
            FAIL = .TRUE.
            WRITE(C3, '(I3)' ) CPT
            POINT_TRACE = 'Raman Fouirer Radiances/Jacobians, point number: '//C3
            RETURN
          ENDIF
...
!    Single layer case (SCOL2). Version 2.5, 9/11/15
            ...
            IF ( NLAYERS .GT. 1 ) THEN
              ...
              IF ( INFO .LT. 0 ) THEN
                ...
                WRITE(C3, '(I3)' ) CPT
                POINT_TRACE = 'Raman Atmospheric Linearization, point number: '//C3
                RETURN
              ENDIF
...
!    Single layer case (SCOL2). Version 2.5, 9/11/15
          ...
          IF ( NLAYERS .GT. 1 ) THEN
            ...
            IF ( INFO .LT. 0 ) THEN
              ...
              MESSAGE = 'DGBTRS: argument i illegal value, for i = '//C2
              WRITE(C3, '(I3)' ) CPT
               POINT_TRACE = 'Raman Fourier, Surface Linearization, point number: '//C3
              RETURN
            ENDIF
