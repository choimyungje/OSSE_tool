...
! #                                                             #
! #   SUBROUTINES :                                             #
! #             L_RRSOPTICAL_MASTER_BIN  (master)               #
! #             L_RRSOPTICAL_MASTER_MONO (master)               #
! #                                                             #
...
!   -- Rob mod 5/12/17 for 2p5a, Renamed L_RRSOptical_Master
...
!   -- Rob mod 5/12/17 for 2p5a, add PHASE FUNCTION Product input (Elastic) and output (Cabannes)
      ...
      MODULE lrrs_L_RRSOptical_master_m

!      USE LRRS_PARS_m, Only : LDU

      PRIVATE
      PUBLIC :: L_RRSOPTICAL_MASTER_BIN, L_RRSOPTICAL_MASTER_MONO

      CONTAINS

      SUBROUTINE L_RRSOPTICAL_MASTER_BIN &
      ...
      if ( DO_PROFILE_WFS .or. DO_COLUMN_WFS ) then
        CALL LRRS_RAMAN_OPS_BIN_PLUS_1 &
          ( MAX_LAYERS, MAX_POINTS, MAX_GEOMETRIES, MAX_BINS, MAX_ATMOSWFS,            & ! Input dimensions
            ...
            DELTAU_INPUT_UNSCALED,     L_DELTAU_INPUT_UNSCALED,                        & ! Inputs Optical
...
!   Rob mod 5/12/17 for 2p5a, Only the names changed
...
!  Finish
      ...
      END SUBROUTINE L_RRSOPTICAL_MASTER_BIN

!

      SUBROUTINE L_RRSOPTICAL_MASTER_MONO &
        ( DO_DELTAM_SCALING, DO_ELASTIC_ONLY, DO_UPWELLING,          & ! Inputs
          DO_DNWELLING, DO_ENERGY_BALANCING, DO_CABANNES_RAMAN,      & ! Inputs
          DO_PROFILE_WFS, DO_COLUMN_WFS, DO_AIRPROFILE_WFS,          & ! Inputs
          DO_TEMPPROFILE_WFS, DO_TEMPSHIFT_WF, DO_NORMALIZED_WFS,    & ! Inputs
...
!  Finish
      ...
      END SUBROUTINE L_RRSOPTICAL_MASTER_MONO

!  End Module

      END MODULE lrrs_L_RRSOptical_master_m
