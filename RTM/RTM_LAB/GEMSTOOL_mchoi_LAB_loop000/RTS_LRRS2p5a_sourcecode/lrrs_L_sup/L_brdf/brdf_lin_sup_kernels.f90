...
!  include file of constants
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, TWO, HALF, MINUS_ONE, PIE
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, MINUS_ONE, ONE, HALF
...
SUBROUTINE BRDF_Generalized_Glint_plus &
      ...
      use LRRS_pars_m, only : fpk, zero, one, two, three, four, half, quarter, PIE
