...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, PIE, PIO2
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, PIE, PIO2, PIO4
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, HALF, PIE, TWO
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, PIE, TWO
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, TWO, PIE, PIO2, PI4
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, TWO, ONEP5, PIE
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, PIE
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, MINUS_ONE, TWO, FOUR, HALF, QUARTER, PIE, PIO2
      USE BRDF_SUP_AUX_M
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, PIE, DEG_TO_RAD, &
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, HALF, PIE
...
!  include file of constants
      ...
      USE LRRS_pars_m, only : fpk, ZERO, ONE, HALF, MINUS_ONE, PIE
...
!  module, dimensions and numbers
      ...
      USE LRRS_pars_m, only : fpk, MINUS_ONE, HALF
...
SUBROUTINE BRDF_Generalized_Glint &
     ...
     use LRRS_pars_m, only : fpk, zero, one, half, quarter, two, three, four, pie
