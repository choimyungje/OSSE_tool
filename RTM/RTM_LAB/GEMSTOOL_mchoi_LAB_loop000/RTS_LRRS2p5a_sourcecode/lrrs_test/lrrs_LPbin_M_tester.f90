...
!  Timing tests
      ...
      REAL :: E1, E2, E3, E4, StdTime, LinTime
...
!  LRRS input control read (USER-DEFINED INPUT)
      ...
      CALL LRRS_READ_INPUTS ( &
        'lrrs_test/lrrs_LPbin_M_tester.cfg', &
...
!  ===========
      ...
      write(*,'(1x,i5,6x,i1,6x,f6.2)') &
        NPOINTS_INNER, 1, LinTime + StdTime
...
!  ==================
      ...
      IF ( DO_ENERGY_BALANCING ) THEN
        FILNAM32 = 'lrrs_test/results_LPAbin_M_tester_EB_SZA' //C2// '_' //C4// '.resg'
      ELSE
        FILNAM32 = 'lrrs_test/results_LPAbin_M_tester_CR_SZA' //C2// '_' //C4// '.resg'
      ENDIF
