...
!  Input data for LRRS code control (USER-DEFINED INPUT)
      ...
      CALL LRRS_READ_INPUTS ( &
        'lrrs_test/lrrs_o3mono_M_tester.cfg', &
...
!  Exception handling. Go to the finish and write errors.
      ...
      IF ( FAIL ) THEN
        WRITE(*,*)
        WRITE(*,*) 'FAIL after LRRS_IOPSETUP_O3MONO_M'
        GO TO 5678
      ENDIF
...
!  Setup output files
      ...
      IF ( DO_ENERGY_BALANCING ) THEN
        FILNAM36 = 'lrrs_test/results_o3mono_M_tester_EB_SZA**_lamb.resg'
      ELSE
        FILNAM36 = 'lrrs_test/results_o3mono_M_tester_CR_SZA**_lamb.resg'
      ENDIF
