...
!
      ix = 1
      call dcabs1(zx(1),smax)
      ix = ix + incx
      do 10 i = 2,n
         call dcabs1(zx(ix),mod)
         if(mod.le.smax) go to 5
         izamax = i
         call dcabs1(zx(ix),smax)
    5    ix = ix + incx
   10 continue
      return
!
...
!
   20 call dcabs1(zx(1),smax)
      do 30 i = 2,n
         call dcabs1(zx(i),mod)
         if(mod.le.smax) go to 30
         izamax = i
         call dcabs1(zx(i),smax)
   30 continue
      return
      end function izamax

      subroutine dcabs1(z,mod)
      double complex z,zz
      double precision t(2),mod
      equivalence (zz,t(1))
      zz = z
      mod = dabs(t(1)) + dabs(t(2))
      return
