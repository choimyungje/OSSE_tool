...
! Numbers such as 1, 2, pie, etc.......
  ...
  REAL (KIND=tmat_fpkind), PARAMETER :: d_zero  = 0.0d0
  REAL (KIND=tmat_fpkind), PARAMETER :: d_one   = 1.0d0
  REAL (KIND=tmat_fpkind), PARAMETER :: d_two   = 2.0d0
  REAL (KIND=tmat_fpkind), PARAMETER :: d_three = 3.0d0
  REAL (KIND=tmat_fpkind), PARAMETER :: d_four  = 4.0d0
  REAL (KIND=tmat_fpkind), PARAMETER :: d_half  = 0.5d0
