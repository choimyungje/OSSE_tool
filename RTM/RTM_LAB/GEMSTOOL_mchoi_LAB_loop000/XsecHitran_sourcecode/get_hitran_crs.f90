...
! ! for test
! WRITE(molc, '(I2.2)') molnum
! hitran_filename = adjustl(trim(HITRAN_path)) // molc // '_hit16.par'    !'_hit08.par'
! ! Recent HITRAN updates
! IF (molnum == 1) THEN
!    hitran_filename = adjustl(trim(HITRAN_path)) // molc // '_hit16.par'    !'_hit09.par'
! ELSE IF (molnum == 7) THEN
!    hitran_filename = adjustl(trim(HITRAN_path)) // molc // '_hit16.par'    !'_hit10.par'
! ELSE IF (molnum == 9) THEN
!    hitran_filename = adjustl(trim(HITRAN_path)) // molc // '_hit16.par'    !'_hit09.par'
! ELSE IF (molnum == 19) THEN
!    hitran_filename = adjustl(trim(HITRAN_path)) // molc // '_hit16.par'    !'_hit09.par'
...
!    hitran_filename = adjustl(trim(HITRAN_path)) // molc // '_hit16.par'    !'_hit10.par'
! ELSE IF (molnum == 26) THEN
!    hitran_filename = adjustl(trim(HITRAN_path)) // molc // '_hit16.par'    !'_hit11.par'
! ELSE IF (molnum == 27) THEN
!    hitran_filename = adjustl(trim(HITRAN_path)) // molc // '_hit16.par'    !'_hit09.par'
! ENDIF
