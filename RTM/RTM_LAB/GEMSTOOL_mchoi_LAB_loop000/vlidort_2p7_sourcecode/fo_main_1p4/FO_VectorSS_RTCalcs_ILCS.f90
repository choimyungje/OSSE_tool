...
!       SSV_Integral_LCS_Plus_1_UP   (Upwelling only)
!       SSV_Integral_LCS_Plus_1_DN   (Downwelling only)
!       SSV_Integral_LCS_Plus_1_UPDN (Upwelling and Downwelling)
...
!mick fix 3/25/2015 - modified if condition
