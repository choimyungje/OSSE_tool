...
SUBROUTINE FO_VectorSS_spherfuncs &
        ( MAXMOMENTS, MAXGEOMS, MAXSZAS, MAXVZAS, MAXAZMS, & ! Inputs
          ...
          STARTER, DO_OBSGEOM, DO_SUNLIGHT, NA_OFFSETS,    & ! Inputs
          DTR, THETA, ALPHA, PHI, COSSCAT, VSIGN,          & ! Inputs
...
!  Section 2b. Legendre only: Nstokes = 1 (scalar case). Return when done
!  -----------------------------------------------------
...
!  Return from Observational Geometry section

   RETURN

!  Continuation point for Lattice calculation
...
!  Section 3b. Legendre only: Nstokes = 1 (scalar case). Return when done
!  -----------------------------------------------------
