...
!  line 97 MAXLAYERS change 75-->101
...
!      INTEGER, PARAMETER :: MAXLAYERS = 20
      INTEGER, PARAMETER :: MAXLAYERS = 25 !27
...
!    (Use full range for exact single scatter calculations)
      ...
      INTEGER, PARAMETER :: MAXMOMENTS_INPUT = 3000
...
!  Maximum number of output optical depths
      ...
      INTEGER, PARAMETER :: MAX_USER_LEVELS = 1 !original=1
...
!      INTEGER, PARAMETER :: MAX_ATMOSWFS = 6!3   for testing 1 gas + 5 aero
      INTEGER, PARAMETER :: MAX_ATMOSWFS = 30

!  Maximum number of surface property weighting functions

      INTEGER, PARAMETER :: MAX_SURFACEWFS = 14 !(3 kernel factor + 3*3 kernel params + 2 sif)
