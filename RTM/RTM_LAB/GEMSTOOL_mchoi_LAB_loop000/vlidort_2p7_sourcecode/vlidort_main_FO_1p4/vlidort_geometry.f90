...
!  Rob Fix 3/17/15. Added MAXFINELAYERS dimension to argument list
!                   in BEAM_GEOMETRY_PREPARE
...
!mick - added initialization
      ...
      DO IB = 1, N_SZANGLES
        ...
        CALL BEAM_GEOMETRY_PREPARE &
           ( MAX_SZANGLES, MAXLAYERS, MAXFINELAYERS, IB, NLAYERS, FINEGRID, &
...
!
      ...
      SUBROUTINE BEAM_GEOMETRY_PREPARE ( &
        MAXBEAMS, MAXLAYERS, MAXFINELAYERS, IBEAM, NLAYERS, FINEGRID, &
...
!  input dimensioning
!  Rob Fix 3/17/15. Added MAXFINELAYERS dimension

      INTEGER, INTENT (IN) ::          MAXLAYERS, MAXFINELAYERS, MAXBEAMS
...
!  Rob Fix 3/17/15. Removed Local dimensioning LOCAL_MAXLAYERS and LOCAL_MAXFINELAYERS
!                   Declarations of ZRFINE, PRFINE, TRFINE, H, DELZ now using input dimensions
...
!  local height arrays
      ...
      DOUBLE PRECISION :: H(0:MAXLAYERS)
...
!  Rob Fix 3/17/15. Removed Local dimensioning, this check no longer required.
