...
!  Local variables
      ...
      !  New 09 Aug 2017
      ! INTEGER ::             OBSERVATION_HEIGHT
      DOUBLE PRECISION ::             OBSERVATION_HEIGHT
...
!   Rob Fix 3/18/15. Added MAX_GEOMETRIES to this list..
      ...
      USE VLIDORT_pars, only : MAX_USER_VZANGLES, MAX_USER_RELAZMS, &
                               ...
                               MAXSTREAMS, MAXLAYERS, MAX_GEOMETRIES, &
...
!  Rob Fix 3/18/15. Geometry dimension to be checked for the LAttice case
      ...
      IF ( .not. VLIDORT_ModIn%MBool%TS_DO_OBSERVATION_GEOMETRY ) THEN
         IF ( MAX_GEOMETRIES.ne.MAX_SZANGLES*MAX_USER_VZANGLES*MAX_USER_RELAZMS ) then
          NM = NM + 1
          MESSAGES(NM) = 'Lattice Case: MAX_GEOMETRIES NOT EQUALis not equal to MAX_SZANGLES*MAX_USER_VZANGLES*MAX_USER_RELAZMS'
...
!mick fix 3/30/2015 - added outer if block
      ...
      IF ( ( NSTOKES.EQ.1 .AND. LOCAL_NADIR_ONLY .AND. &
             (.NOT.DO_SSFULL .OR. .NOT.DO_SSCORR_NADIR .OR. .NOT.DO_SSCORR_OUTGOING) ) &
