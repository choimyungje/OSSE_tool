...
!  Fixed Linearized Control inputs
      ...
      ! write(*,*)'vlidort_lcs_masters: N_SURFACE_WFS ',N_SURFACE_WFS
      ! ! write(*,*) N_SURFACE_WFS, N_SLEAVE_WFS, N_TOTALSURFACE_WFS
      ! pause !mchoi
...
!  BRDF Linearized Supplement inputs
      ...
      !    incident solar directions,   reflected user streams ---mchoi needed
      LS_USER_BRDF_F_0&
...
!   Rob Fix 3/17/15. Exception handling updated for serious error.
          ...
          IF ( DO_SSCORR_OUTGOING .AND. .NOT.DO_FO_CALC ) THEN
           ...
           IF ( DO_ATMOS_LINEARIZATION ) THEN
            ...
            IF ( FAIL ) THEN
               TRACE_2 = 'Linearized SS correction outgoing, failed in VLIDORT_LCS_MASTER'
               TRACE_3 = ' ** VLIDORT_LCS_MASTER '
               STATUS_CALCULATION = VLIDORT_SERIOUS
               VLIDORT_Out%Status%TS_STATUS_CALCULATION = STATUS_CALCULATION
               VLIDORT_Out%Status%TS_MESSAGE = MESSAGE
           ...
           ELSE
            ...
            IF ( FAIL ) THEN
               TRACE_2 = 'SS correction outgoing, failed in VLIDORT_LCS_MASTER'
               TRACE_3 = ' ** VLIDORT_LCS_MASTER '
               STATUS_CALCULATION = VLIDORT_SERIOUS
               VLIDORT_Out%Status%TS_STATUS_CALCULATION = STATUS_CALCULATION
               VLIDORT_Out%Status%TS_MESSAGE = MESSAGE
...
!  Rob Fix, 20 March 2015. Generalized for Lattice or ObsGeom
...
!  Surface weighting functions
      ...
      ! write(*,*)  'vlidort_lcs_masters: N_TOTALSURFACE_WFS  ', N_TOTALSURFACE_WFS
      ! pause!mchoi
...
!mick fix 9/6/2012 - added (N_SURFACE_WFS > 0) IF condition
            IF ( N_SURFACE_WFS > 0 ) THEN
              ...
              CALL SURFACEWF_MASTER ( &
                ...
                ! write(*,*) N_SURFACE_WFS, N_SLEAVE_WFS
                ! pause !mchoi
!  Exception handling
