...
!  output and (2) user-angle output (diffuse + direct)
      ...
      CALL GET_BOA_SOURCE ( DO_INCLUDE_SURFACE, &
        DO_INCLUDE_DIRECTBEAM, &
        DO_MSMODE_THERMAL, DO_INCLUDE_SURFEMISS, &
        DO_USER_STREAMS, DO_INCLUDE_MVOUTPUT, &
        ...
        T_WLOWER, BRDF_F, &
        STOKES_DOWNSURF, BOA_THTONLY_SOURCE, &
        BOA_DIFFUSE_SOURCE, BOA_DIRECT_SOURCE )
...
!
      ...
      SUBROUTINE GET_BOA_SOURCE ( DO_INCLUDE_SURFACE, &
        DO_INCLUDE_DIRECTBEAM, &
        DO_MSMODE_THERMAL, DO_INCLUDE_SURFEMISS, &
        DO_USER_STREAMS, DO_INCLUDE_MVOUTPUT, &
        DO_OBSERVATION_GEOMETRY, &
...
!mick fix 3/31/2015 - added DO_USER_STREAMS to if condition
        IF ( DO_USER_STREAMS .AND. DO_INCLUDE_DIRECTBEAM .AND. .NOT.DO_DBCORRECTION ) THEN
          IF ( .NOT. DO_OBSERVATION_GEOMETRY ) THEN
            DO UM = LOCAL_UM_START, N_USER_STREAMS
              DO O1 = 1, NSTOKES
