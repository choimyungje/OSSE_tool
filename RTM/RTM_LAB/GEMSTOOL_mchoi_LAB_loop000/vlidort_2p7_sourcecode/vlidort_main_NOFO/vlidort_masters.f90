...
!  special code with NO VFO Interface. June 5th, 2015
!  Code adapted from the June 4th OFFICIAL version
...
!  ---------------
      ...
      INTEGER ::          UM, UA, TESTCONV, L, LUM, LUA, V
...
!            write(*,*) 'ss-intu',STOKES_SS(1:N_USER_LEVELS,1,1,1)
!            write(*,*) 'ss-intd',STOKES_SS(1:N_USER_LEVELS,1,1,2)
!            write(*,*) 'db int',STOKES_DB(1:N_USER_LEVELS,1,1)
...
!              FO_STOKES, FAIL, MESSAGE, TRACE_1, TRACE_2 )                     ! Output
...
!  Rob Fix 3/19/15. FO Version 1.4 has Lattice mode as well
...
!           write(*,*) 'ssu',STOKES_SS(1:N_USER_LEVELS,1,1,1)
!           write(*,*) 'ssd',STOKES_SS(1:N_USER_LEVELS,1,1,2)
!           write(*,*) 'db',STOKES_DB(1:N_USER_LEVELS,1,1)
