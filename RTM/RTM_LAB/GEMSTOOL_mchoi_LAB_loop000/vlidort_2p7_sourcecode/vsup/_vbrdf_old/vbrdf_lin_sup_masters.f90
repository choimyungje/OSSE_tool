...
!  Compute total number of pars
          ...
          ! write(*,*) N_KERNEL_FACTOR_WFS, N_KERNEL_PARAMS_WFS
          ! pause !mchoi
        ENDIF
...
!  Copy linearized BRDF inputs
      ...
      write(*,*)'vbrdf_lin_sup_masters: N_SURFACE_WFS  ', N_SURFACE_WFS
      write(*,*)'vbrdf_lin_sup_masters: N_KERNEL_FACTOR_WFS  ', N_KERNEL_FACTOR_WFS
      write(*,*)'vbrdf_lin_sup_masters: N_KERNEL_PARAMS_WFS  ', N_KERNEL_PARAMS_WFS
! !  Finish
!       write(*,*) NSTREAMS_BRDF, MAXSTREAMS_BRDF
!       pause
      ! pause
...
!    * Exception handling introduced Version 2.7
      ...
      IF ( .not. DO_NewCMGLINT .and. (.not. DO_BSAVALUE_WF .and. .not. DO_WSAVALUE_WF ) ) then
         ...
         ENDDO
         N_SURFACE_WFS = N_KERNEL_FACTOR_WFS + N_KERNEL_PARAMS_WFS
        !  write(*,*)N_KERNEL_FACTOR_WFS, N_KERNEL_PARAMS_WFS, N_SURFACE_WFS
        !  write(*,*)WOFFSET
        !  pause!mchoi
            ...
            DO O1 = 1, NSTOKESSQ
              DO IB = 1, NBEAMS
                VBRDF_LinSup_Out%BS_LS_DBOUNCE_BRDFUNC(W,O1,LUM,LUA,IB) = &
                  ...
                  ! write(*,*) NSTOKESSQ, NBEAMS
                  ! write(*,*) DBKERNEL_BRDFUNC(O1,LUM,LUA,IB)
                  ! pause !mchoi
              ...
              DO IB = 1, NBEAMS
                ...
                ELSE IF ( N_SURFACE_WFS .gt. 0) then
                  DO W = 1, N_SURFACE_WFS
                    ...
                    ! write(*,*)VBRDF_LinSup_Out%BS_LS_DBOUNCE_BRDFUNC(W,Q,LUM,LUA,IB)
                    ! pause
                  ENDDO
                ENDIF
              ENDDO
