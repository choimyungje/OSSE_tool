...
!    !@@ Rob Fix 9/25/14. Always calculated for Solar Sources
      ...
      !mick fix 9/19/2017 - initialize DBKERNEL_BRDFUNC !mchoi
      ! DBKERNEL_BRDFUNC = ZERO !mchoi
...
!              LOCAL_BRDF_F_0(1:NSTOKESSQ,I,IB) = ONE    !! EGREGIOUS Bug. 20 March 2019
            ENDDO
          ENDDO
        ENDIF
      ENDIF
...
!            LOCAL_BRDF_F(1:NSTOKESSQ,I,J) = ONE   !! EGREGIOUS Bug. 20 March 2019
          ENDDO
        ENDDO
      ENDIF
...
!                LOCAL_USER_BRDF_F_0(1:NSTOKESSQ,LUM,IB) = ONE  !! EGREGIOUS Bug. 20 March 2019
              ENDDO
            ENDIF
          ELSE
            IF ( .NOT. LAMBERTIAN_FLAG ) THEN
...
!                  LOCAL_USER_BRDF_F_0(1:NSTOKESSQ,UI,IB) = ONE  !! EGREGIOUS Bug. 20 March 2019
                ENDDO
              ENDDO
            ENDIF
          ENDIF
...
!              LOCAL_USER_BRDF_F(1:NSTOKESSQ,UI,J) = ONE  !! EGREGIOUS Bug. 20 March 2019
            ENDDO
          ENDDO
        ENDIF
