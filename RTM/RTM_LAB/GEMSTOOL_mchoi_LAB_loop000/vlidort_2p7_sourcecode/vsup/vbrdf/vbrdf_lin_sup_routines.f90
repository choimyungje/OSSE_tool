...
!  include file of dimensions and numbers
      ...
      USE vlidort_pars, Only : MAXSTREAMS_BRDF, MAXSTREAMS_SCALING, MAX_BRDF_PARAMETERS, ZERO, ONE, HALF
...
!  include file of dimensions and numbers
      ...
      USE vlidort_pars, Only : MAXSTOKES_SQ, MAX_USER_STREAMS, MAXSTREAMS, MAXBEAMS, MAXSTOKES, &
