...
! ###############################################################
      ...
      USE vlidort_pars, only : FPK, ZERO, ONE, TWO, HALF, QUARTER, PIE
...
!  include file of dimensions and numbers
      ...
      USE vlidort_pars, only : zero, one, pie, MAXSTREAMS_BRDF, MAXSTHALF_BRDF
...
!  include file of dimensions and numbers
      ...
      USE vlidort_pars, only : half, two, pie, MAXSTREAMS_BRDF, MAXSTHALF_BRDF
