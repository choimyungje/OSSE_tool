...
!     - required for the New Cox-Munk Subroutines (Version 2.7) 
      ...
      use vlidort_pars , only : fpk, zero, one, two, three, four, half, quarter, minus_one, pie
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, MAXSTOKES_SQ
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, MAXSTOKES_SQ, PIE, PIO2
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, MAXSTOKES_SQ, PIE, PIO2, PIO4
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, HALF, THREE, MAXSTOKES_SQ, &
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, TWO, MAXSTOKES_SQ, PIE,  PI4
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, TWO, HALF, MAXSTOKES_SQ, PIE
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, TWO, MAXSTOKES_SQ, PIE
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, TWO, ONEP5, MAXSTOKES_SQ, PIE
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, ONE, MAXSTOKES_SQ, PIE
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, HALF, ONE, TWO, FOUR, MINUS_ONE, MAXSTOKES_SQ, PIE, PIO2
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, HALF, ONE, TWO, MAXSTOKES_SQ, PIE
...
!  include file of constants
      ...
      USE vlidort_pars, only : ZERO, DEG_TO_RAD, MAXSTOKES_SQ, max_msrs_muquad, max_msrs_phiquad
...
!  module, dimensions and numbers
      ...
      USE vlidort_pars, only : ZERO, ONE, TWO, HALF, MINUS_ONE, PIE
